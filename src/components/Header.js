...
const Header = () => {
  ...
  return (
    <div className="absolute left-0 right-0 px-8 py-2 bg-gradient-to-b from-black z-10 flex justify-between">
      <img
      ...
      {user && (
        <div className="flex">
          <img className="w-10 my-auto" src={user?.photoURL} alt="User Icon" />
